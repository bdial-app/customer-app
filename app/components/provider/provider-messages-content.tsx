...
const enquiryBadge: Record<string, { label: string; cls: string }> = {
  product: { label: "Quote", cls: "bg-amber-50 text-amber-700" },
  listing: { label: "Booking", cls: "bg-teal-50 text-teal-700" },
  provider: { label: "Chat", cls: "bg-slate-50 text-slate-600" },
  direct: { label: "Chat", cls: "bg-slate-50 text-slate-600" },
};
      ...
      <div className="px-4 pt-2 pb-1 flex gap-2">
        ...
        <div className="flex-1 bg-amber-50 rounded-xl px-3 py-2 flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[9px] text-amber-600/60">Enquiries</p>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <h4 className={`text-[14px] leading-tight truncate ${conv.unreadCount > 0 ? "font-bold text-slate-900" : "font-semibold text-slate-700"}`}>
                          {name}
                        </h4>
                      ...
                      <div className="flex items-center justify-between gap-2 mt-0.5">
                        <div className="flex items-center gap-1 min-w-0 flex-1">
                          ...
                          <p className={`text-[12px] truncate ${conv.unreadCount > 0 ? "text-slate-700 font-medium" : "text-slate-500"}`}>
