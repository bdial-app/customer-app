  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden bg-gray-100">
        ...
        {/* Price tag */}
        {product.price != null && (
          <div className="absolute top-2 right-2 bg-white/95 backdrop-blur-sm text-gray-900 text-[12px] font-bold px-2 py-1 rounded-lg shadow-sm">
        ...
        {product.distance != null && (
          <div className="absolute bottom-2 left-2 bg-white/95 backdrop-blur-sm text-gray-700 text-[10px] font-semibold px-2 py-1 rounded-lg flex items-center gap-1 shadow-sm">
      ...
      <div className="p-3">
        ...
        <div className="flex items-center gap-1 mt-1.5">
          <IonIcon icon={storefrontOutline} className="w-3 h-3 text-gray-400 flex-shrink-0" />
