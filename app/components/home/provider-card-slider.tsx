      ...
      {isLoading ? (
        <div className="flex gap-3 overflow-hidden pl-4 pr-4 pb-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="shrink-0 w-[150px] bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 animate-pulse"
            >
              ...
              <div className="p-2.5 space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="h-3 w-14 bg-slate-200 dark:bg-slate-700 rounded-full mt-1" />
                </div>
              </div>
            </div>
          ))}
