      ...
      {isLoading ? (
        <div className="grid grid-cols-2 gap-3 px-4 pb-3">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-700 animate-pulse"
            >
              ...
              <div className="p-2.5 space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="h-3 w-10 bg-slate-200 dark:bg-slate-700 rounded-full mt-1" />
                </div>
