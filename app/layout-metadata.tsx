// This file contains metadata configurations for different routes
// Import this in individual layout.tsx files as needed
...
export const loginMetadata: Metadata = {
  title: "Login - Tijarah",
  description: "Sign in to your Tijarah account to access services and manage your profile",
};
...
export const productDetailsMetadata: Metadata = {
  title: "Service Details - Tijarah",
  description: "View detailed information about services offered on Tijarah",
};
...
export const inviteMetadata: Metadata = {
  title: "Invite Friends - Tijarah",
  description: "Share Tijarah with your friends and earn rewards when they join",
};

export const galleryMetadata: Metadata = {
  title: "Gallery - Tijarah",
  description: "Browse photos and images on Tijarah",
};
