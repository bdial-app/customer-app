      ...
      >
                ...
                <div className="relative p-4">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center">
                      <IonIcon icon={globeOutline} className="w-3.5 h-3.5 text-white" />
                    </div>
                  ...
                  <div className="flex items-center justify-center gap-4 mb-3">
                    {provider.instagramHandle && (
                      ...
                      >
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#833AB4] via-[#E4405F] to-[#FCAF45] flex items-center justify-center shadow-md shadow-pink-200/40 dark:shadow-pink-900/20 group-active:scale-90 transition-transform">
                          <IonIcon icon={logoInstagram} className="w-5 h-5 text-white" />
                        </div>
                    ...
                    {provider.facebookHandle && (
                      <a
                        ...
                        className="group flex flex-col items-center gap-1.5"
                      >
                        <div className="w-12 h-12 rounded-full bg-[#1877F2] flex items-center justify-center shadow-md shadow-blue-200/40 dark:shadow-blue-900/20 group-active:scale-90 transition-transform">
                          <IonIcon icon={logoFacebook} className="w-5 h-5 text-white" />
                        </div>
                    ...
                    {provider.youtubeHandle && (
                      <a
                        ...
                        className="group flex flex-col items-center gap-1.5"
                      >
                        <div className="w-12 h-12 rounded-full bg-[#FF0000] flex items-center justify-center shadow-md shadow-red-200/40 dark:shadow-red-900/20 group-active:scale-90 transition-transform">
                          <IonIcon icon={logoYoutube} className="w-5 h-5 text-white" />
                        </div>
                    ...
                    {provider.whatsappNumber && (
                      <a
                        ...
                        className="group flex flex-col items-center gap-1.5"
                      >
                        <div className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center shadow-md shadow-green-200/40 dark:shadow-green-900/20 group-active:scale-90 transition-transform">
                          <IonIcon icon={logoWhatsapp} className="w-5 h-5 text-white" />
                        </div>
                  ...
                  {provider.websiteUrl && (
                    ...
                    >
                      {provider.websiteLogoUrl ? (
                        <img src={provider.websiteLogoUrl} alt="" className="w-5 h-5 rounded-md object-contain shrink-0" />
                      ) : (
                        <div className="w-5 h-5 rounded-md bg-indigo-100 dark:bg-indigo-900/40 flex items-center justify-center shrink-0">
                          <IonIcon icon={globeOutline} className="w-3 h-3 text-indigo-500" />
                        </div>
                      )}
        ...
        {activeTab === "Reviews" && (
          <div className="px-5 pt-5 pb-28 space-y-4">
            ...
            {combinedData?.googleReviews && combinedData.googleReviews.length > 0 && (
              <>
                ...
                {combinedData.googleReviews.map((gr: GoogleReview, idx: number) => (
                  <div
                    key={`google-${idx}`}
                    className="bg-white dark:bg-slate-800 rounded-2xl p-4 border border-gray-100/80 dark:border-slate-700 shadow-[0_1px_3px_rgba(0,0,0,0.04)] dark:shadow-none"
                  >
                    <div className="flex items-start justify-between mb-2.5">
                      <div className="flex items-center gap-2.5">
                        {gr.authorPhotoUrl ? (
                          <img
                            src={gr.authorPhotoUrl}
                            alt=""
                            className="w-10 h-10 rounded-full object-cover shrink-0"
                          />
                        ) : (
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center text-sm font-bold text-blue-500 shrink-0">
                            {gr.authorName?.charAt(0) || "G"}
                          </div>
                        )}
                        <div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-medium bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                              Google
                            </span>
                          </div>
                          <span className="text-[11px] text-gray-400">
                            {gr.relativeTimeDescription}
                          </span>
                        </div>
                      </div>
                      <StarRow rating={gr.rating} size={12} />
                    </div>
                    {gr.text && (
                      <p className="text-[13px] text-gray-600 dark:text-slate-300 leading-relaxed">
                        {gr.text}
            ...
            {products.length === 0 ? (
              ...
              <div className="space-y-5">
                ...
                {[...products].filter(p => p.isHero).length > 0 && (
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-widest text-amber-500 dark:text-amber-400 mb-3">Hero Products &amp; Services</p>
                          ...
                          <Link key={product.id} href={`${ROUTE_PATH.PRODUCT_DETAILS}?id=${product.id}`}>
                            <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-amber-200/70 dark:border-amber-700/40 shadow-[0_0_16px_rgba(251,191,36,0.18)] dark:shadow-[0_0_16px_rgba(251,191,36,0.12)] active:scale-[0.97] transition-transform">
                              ...
                              <div className="p-3.5">
                                ...
                                {/* Hero tag */}
                                <div className="flex items-center gap-1.5 mt-2 pt-2 border-t border-amber-100 dark:border-amber-800/30">
                                  <span className="text-amber-400 text-[10px]">★</span>
                                  <span className="text-[9px] font-bold text-amber-500 dark:text-amber-400 uppercase tracking-wider">
                                    {isService ? "Hero Service" : "Hero Product"}
                                  </span>
                                </div>
                              </div>
                            </div>
