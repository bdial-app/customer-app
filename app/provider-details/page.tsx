...
const STATIC_REVIEWS = [
  {
    ...
    starRating: 5,
    reviewText:
      "Absolutely amazing service! The quality of work exceeded my expectations. Highly recommended for anyone looking for professional service.",
    status: "active",
    postedAt: new Date(Date.now() - 2 * 86400000).toISOString(),
    reviewer: { id: "u1", name: "Fatima Bohra" },
    photos: [],
  },
  {
    id: "sr2",
    ...
    starRating: 4,
    reviewText:
      "Very good experience overall. Prompt delivery and great attention to detail. Will definitely come back again.",
    status: "active",
    postedAt: new Date(Date.now() - 5 * 86400000).toISOString(),
    reviewer: { id: "u2", name: "Ahmed Hussain" },
    photos: [],
  },
  {
    id: "sr3",
    ...
    starRating: 5,
    reviewText:
      "Best in the area! Fair pricing and excellent craftsmanship. The owner is very friendly and accommodating.",
    status: "active",
    postedAt: new Date(Date.now() - 12 * 86400000).toISOString(),
    reviewer: { id: "u3", name: "Sakina Merchant" },
    photos: [],
  },
  {
    id: "sr4",
    ...
    starRating: 4,
    reviewText:
      "Good quality work. Slightly delayed but the end result was worth the wait.",
    status: "active",
    postedAt: new Date(Date.now() - 20 * 86400000).toISOString(),
    reviewer: { id: "u4", name: "Murtaza Ali" },
    photos: [],
  },
  {
    id: "sr5",
    ...
    starRating: 5,
    reviewText:
      "Outstanding! This is my go-to place now. Professional, reliable, and affordable.",
    status: "active",
    postedAt: new Date(Date.now() - 30 * 86400000).toISOString(),
    reviewer: { id: "u5", name: "Zahra Bhai" },
    photos: [],
  },
];
...
const STATIC_PRODUCTS = [
  {
    ...
    description: "Our best-selling premium service package with full coverage",
    price: 1999,
    currency: "INR",
    photoUrl:
  ...
  },
  {
    ...
    description: "Quality service at an affordable price point",
    price: 999,
    currency: "INR",
  ...
  },
  {
    ...
    price: 1499,
    currency: "INR",
    photoUrl: "https://images.unsplash.com/photo-1556740758-90de940de450?w=400",
    isActive: true,
    displayOrder: 3,
  },
  {
    ...
    price: 499,
    currency: "INR",
    photoUrl: "https://images.unsplash.com/photo-1556742393-d75f468bfcb0?w=400",
    isActive: true,
    displayOrder: 4,
  },
];
  ...
  if (isError || !provider) {
    return (
      <Page className="flex flex-col items-center justify-center p-8">
        ...
        <button
          onClick={() => router.back()}
          className="px-6 py-2.5 bg-amber-500 text-white rounded-full text-sm font-semibold active:scale-95 transition-transform"
        >
          Go Back
        </button>
      </Page>
    ...
    <Page className="!bg-gray-50/80">
        ...
        <div className="relative h-72 overflow-hidden">
          ...
          {galleryImages.length > 0 && (
            <button
              ...
              className="absolute top-4 right-4 flex items-center gap-1.5 bg-black/40 backdrop-blur-md text-white text-xs font-medium px-3 py-1.5 rounded-full active:scale-95 transition-transform"
            ...
            <div className="bg-white rounded-2xl p-4 border border-gray-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
              ...
              <div className="space-y-2.5">
                {listings.map((l) => (
                  <div
                    key={l.id}
                    className="flex items-start gap-3 p-2.5 rounded-xl bg-gray-50/80"
                  >
                    ...
                    <div className="group bg-white rounded-2xl overflow-hidden border border-gray-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.04)] active:scale-[0.98] transition-transform">
                      ...
                      <div className="p-3">
                        ...
                        <p className="text-[11px] text-gray-400 mb-2 line-clamp-1">
                          {product.description || product.businessName}
                        </p>
      ...
      >
        <div className="flex gap-3">
          ...
          <button
            onClick={() => window.open(`tel:${provider.contactNumber}`)}
            className="flex-1 flex items-center justify-center gap-2 py-3 bg-amber-500 rounded-2xl text-sm font-semibold text-white shadow-sm shadow-amber-200 active:scale-[0.98] transition-transform"
          >
